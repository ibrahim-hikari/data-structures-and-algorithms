...
const firstLetters = arr => {
    let result = arr.map(value => value.charAt(0));
    return result;
};
...
const findHappiness = arr => {
    let result = arr.filter(val => val.includes(':)'));
    return result
};
...
const standardizePhoneNumbers = arr => {
    let result = arr.map(val => val.replace(/[() -]/g, ''));
    return result
};
...
const allHappy = arr => {
    let result = arr.every(val => val.includes(':)'));
    return result
};
...
const findAnything = (arr, target) => {
    let result = arr.filter(val => val.includes(target));
    return result
};
...
const findEvery = (arr, target) => {
    let result = arr.every(val => val.includes(target));
    return result
};
...
const unenrollBrook = arr => {
    let result = arr.map(course => course.filter(val => !val.includes('Brook')));
    return result
};
